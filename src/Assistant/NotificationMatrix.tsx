...
const NOTIFICATION_CHANNELS_KEY = `${appBrand.storageNamespace}:assistant_notification_channels_v1`;

const DEFAULT_CHANNELS: NotificationChannel[] = [
    { id: '1', name: '5G 短信通知', description: '基于 5G 消息增强下发，支持多媒体交互报障', enabled: true, type: 'sms' },
    { id: '2', name: 'App 实时推送', description: `${appBrand.serviceEndpointName}实时 Push 告警`, enabled: true, type: 'app' },
