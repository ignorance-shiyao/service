...
export const FOLDER_SCENE_LAYOUTS: Record<string, RegistryLayout> = {
  ...
  idc3: {
    ...
    items: [
      ...
      item('idc3', 'server_cabinet', 'idcServerCabFront', 420, 610, 175, 270, '服务器柜'),
      item('idc3', 'ups_main', 'idcUpsMain', 70, 535, 190, 270, 'UPS 主机'),
      item('idc3', 'battery_cabinet', 'idcBatteryCab', 255, 610, 190, 220, '电池柜'),
      item('idc3', 'precision_ac', 'idcPrecisionAc', 1340, 220, 225, 255, '精密空调'),
      item('idc3', 'fire_cylinders', 'idcFireCyl', 1395, 585, 165, 220, '气体灭火钢瓶'),
      item('idc3', 'access_door', 'idcAccessDoor', 1000, 700, 200, 175, '门禁入口'),
      item('idc3', 'pdu_strip', 'idcPduStrip', 1455, 790, 145, 48, 'PDU 电源条'),
      item('idc3', 'alarm_beacon', 'idcAlarmBeacon', 1580, 555, 55, 145, '告警灯柱'),
      item('idc3', 'smoke_detector_1', 'idcSmokeSensor', 770, 150, 54, 50, '烟感 1'),
  ...
  cmpA: {
    ...
    items: [
      ...
      item('cmpA', 'battery_cabinet', 'idcBatteryCab', 255, 610, 190, 220, '电池柜'),
      item('cmpA', 'precision_ac', 'idcPrecisionAc', 1340, 220, 225, 255, '精密空调'),
